...
const fetchPageData = async () => {
  ...
  try {
    ...
    if (data.graph) {
      ...
      const generatedGraph = generateLayoutGraph(data.points); // TODO generateFraph will also now have extra information (number of edges of each node a edge overlaps)
